...
type Mina = {
    ...
    fetchEvents: (publicKey: PublicKey, tokenId?: Field, filterOptions?: EventActionFilterOptions, headers?: HeadersInit) => ReturnType<typeof Fetch.fetchEvents>;
    fetchActions: (publicKey: PublicKey, actionStates?: ActionStates, tokenId?: Field, from?: number, to?: number, headers?: HeadersInit) => ReturnType<typeof Fetch.fetchActions>;
 ...
 */
declare function fetchEvents(publicKey: PublicKey, tokenId: Field, filterOptions?: EventActionFilterOptions, headers?: HeadersInit): Promise<{
    events: {
        data: string[];
        transactionInfo: {
            hash: string;
 ...
 */
declare function fetchActions(publicKey: PublicKey, actionStates?: ActionStates, tokenId?: Field, from?: number, to?: number, headers?: HeadersInit): Promise<{
    actions: string[][];
    hash: string;
}[] | {
    error: {
