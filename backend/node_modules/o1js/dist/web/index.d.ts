...
export { AlmostForeignField, CanonicalForeignField, createForeignField, ForeignField, } from './lib/provable/foreign-field.js';
...
export type { FlexibleProvable, FlexibleProvablePure, InferProvable, ProvableExtended, } from './lib/provable/types/struct.js';
...
import { IndexedMerkleMap as IndexedMerkleMap_, IndexedMerkleMapBase } from './lib/provable/merkle-tree-indexed.js';
export declare let IndexedMerkleMap: typeof IndexedMerkleMap_;
...
export { Transaction, type IncludedTransaction, type PendingTransaction, type PendingTransactionPromise, type RejectedTransaction, type TransactionPromise, } from './lib/mina/v1/transaction.js';
...
import { KimchiJsonProof as KimchiJsonProof_, KimchiProof as KimchiProof_, KimchiVerificationKey as KimchiVerificationKey_, ZkFunction as ZkFunction_ } from './lib/proof-system/zkfunction.js';
...
declare namespace Experimental {
    ...
    let ZkFunction: typeof ZkFunction_;
    type KimchiProof = KimchiProof_;
    type KimchiVerificationKey = KimchiVerificationKey_;
    let KimchiProof: typeof KimchiProof_;
    let KimchiVerificationKey: typeof KimchiVerificationKey_;
